...
export default function Hero() {
  return (
    <section className="max-w-[900px] mx-auto px-6 pt-[140px] pb-20">
      <FadeIn>
      ...
      <FadeIn delay={0.1}>
        <h1 className="font-display text-[52px] font-bold leading-[1.1] tracking-[-0.04em] text-[#1a1a1a] mb-5 max-w-[600px]">
          Hi, I&apos;m Lafia<br/>Adam Bagri
        </h1>
      </FadeIn>
      <FadeIn delay={0.2}>
        <p className="text-[17px] leading-[1.7] text-[#666] max-w-[520px] font-light">
